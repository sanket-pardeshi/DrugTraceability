...
public class DrugTraceabilityWithSQL extends JFrame implements ActionListener {
    ...
    private final
    SortedMap<String, Block> blockList;
    private final
    SortedMap<String, Integer> date_cnt;
    ...
    public DrugTraceabilityWithSQL() {
...
//            String url = "jdbc:mysql://127.0.0.1:3306/drug_traceability";
            ...
            // Create the drug traceability table if it doesn't e
